...
router
.route("/admin/users")
.get(isAuthenticationUser,authorizationRoles("admin"),getAllUser);

router.
route("/admin/user/:id")
.get(isAuthenticationUser,authorizationRoles("admin"),getSingleUser)
.put(isAuthenticationUser,authorizationRoles("admin"),updateUserRole)
.delete(isAuthenticationUser,authorizationRoles("admin"),deleteUser)
